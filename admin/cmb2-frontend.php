...
if (!class_exists('CMB2_Frontend_Form_Bs'))
    return false;
    ...
    */
    function form( $atts = array() ) {
        ...
        $styling = [
            ...
            'cmb2_textarea'             => 'cmb2_textarea w-100 form-control',
            'cmb2-textarea-small'       => 'cmb2-textarea-small w-100 form-control d-inline-block',
    ...
    function handle_user_submit($cmb, $post_data = array()){
