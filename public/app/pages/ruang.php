<?php
if ( isset( $_POST['vdel_ruang_field'] ) && wp_verify_nonce( $_POST['vdel_ruang_field'], 'vdel_ruang_action' ) ) {
    update_option( 'vdel_ruang', $_POST['ruang'] );
...
$vdel_ruang = get_option( 'vdel_ruang' );
$vdel_ruang = $vdel_ruang?$vdel_ruang:['Ruang 1','Ruang 2','Ruang 3'];
?>
...
<form action="" method="POST" class="table-responsive">
    <table class="table table-hover table_vdel">
        ...
        <tbody>
            <?php foreach( $vdel_ruang as $i => $vl): ?>
                <tr> 
                    <td>
                        <input type="text" value="<?php echo $vl ; ?>" name="ruang[]" class="form-control form-control-sm border-0 bg-transparent">
                    </td>
                    <td class="text-end">
    ...
    <?php wp_nonce_field( 'vdel_ruang_action', 'vdel_ruang_field' ); ?>
